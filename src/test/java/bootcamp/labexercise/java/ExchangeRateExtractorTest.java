...
public class ExchangeRateExtractorTest {
    ...
    public void shouldReturnTrue(){
        Map<Currency, BigDecimal> expectedMap = new HashMap<>() {{
        ...
        Map<Currency, BigDecimal> extractedMap = ExchangeRateExtractor.parsXml("fx-rates.xml");
        assertEquals(extractedMap,expectedMap);
